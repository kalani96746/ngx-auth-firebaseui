...
export function addPackageJsonDependencies(): Rule {
  return (host: Tree, context: SchematicContext) => {
    ...
    const dependencies: NodeDependency[] = [
      {type: NodeDependencyType.Default, version: loadPackageVersionGracefully() || '7.1.3', name: 'ngx-auth-firebaseui'},
      {type: NodeDependencyType.Default, version: ngCoreVersionTag || '16.2.12', name: '@angular/animations'},
      {type: NodeDependencyType.Default, version: ngCoreVersionTag || '16.2.12', name: '@angular/forms'},
      {type: NodeDependencyType.Default, version: ngCoreVersionTag || '16.2.12', name: '@angular/router'},
      {type: NodeDependencyType.Default, version: '^7.6.1', name: '@angular/fire'},
      {type: NodeDependencyType.Default, version: '^9.23.0', name: 'firebase'}
    ];
